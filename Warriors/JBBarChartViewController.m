...
CGFloat const kJBBarChartViewControllerChartPadding = 64.0f;
...
- (void)loadView
{
    ...
    self.barChartView.frame = CGRectMake(10, kJBBarChartViewControllerChartPadding, self.view.bounds.size.width - 20, kJBBarChartViewControllerChartHeight);
